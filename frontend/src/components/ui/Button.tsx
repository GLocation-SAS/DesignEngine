  ...
  "inline-flex items-center justify-center rounded-full text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 disabled:pointer-events-none disabled:bg-semantic-background-disabled-surface disabled:text-semantic-text-disabled-default disabled:border-transparent active:scale-95 w-full",
  {
    variants: {
      variant: {
        ...
        neutral: "bg-semantic-background-neutral-surface text-semantic-text-disabled-default border border-semantic-background-neutral-muted hover:bg-semantic-background-neutral-hover hover:text-semantic-text-on-color hover:border-semantic-background-neutral-hover hover:shadow-[inset_0px_0px_13.1px_1px_#D4D4D8] active:bg-semantic-background-neutral-pressed active:text-semantic-text-on-color active:border-semantic-background-neutral-pressed",
        outline: "border border-primary-500 bg-transparent text-primary-500 hover:bg-primary-50 active:bg-primary-100",
    ...
    compoundVariants: [
      ...
      // Neutral States
      { variant: "neutral", state: "hover", className: "!bg-semantic-background-neutral-hover !text-semantic-text-on-color !border-semantic-background-neutral-hover !shadow-[inset_0px_0px_13.1px_1px_#D4D4D8]" },
