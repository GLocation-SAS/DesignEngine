...
const STATES = [
  ...
  { key: "hover", label: "Hover", props: { className: "bg-semantic-background-primary-hover shadow-[inset_0px_2px_13.1px_0px_#B091DB]" } },
  { key: "active", label: "Pressed", props: { className: "bg-semantic-background-primary-pressed" } },
  { key: "disabled", label: "Disabled", props: { disabled: true } },
];

export function PrimaryButtonMatrix() {
  return (
    <div className="space-y-10 p-10 bg-neutral-100/50 rounded-[40px] border border-neutral-200 dark:border-neutral-800 shadow-xl overflow-hidden">
      <div className="flex items-center justify-between mb-8">
        <div className="space-y-1">
          <Badge variant="surface" className="bg-primary-50 text-primary-600">Primary Button</Badge>
          <h3 className="text-2xl font-black tracking-tight text-neutral-900 dark:text-white">Component Instance: node-2130-11365</h3>
        </div>
      </div>
