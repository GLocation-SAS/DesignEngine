    ...
    <div className="space-y-32 mt-16 pb-32 max-w-6xl">
      ...
      <div className="px-8 space-y-4">
        <div className="flex items-center gap-3">
          <Badge variant="outline" className="bg-secondary-600 text-white uppercase tracking-widest text-[10px]">Button System</Badge>
          <span className="text-sm font-medium text-neutral-400 dark:text-neutral-500 italic">Secondary Variant</span>
        </div>
        <h2 className="text-5xl font-black tracking-tighter text-primary-500 uppercase">Secondary Action</h2>
        <p className="text-neutral-500 max-w-2xl text-lg">
          Variante secundaria para acciones de menor jerarquía, manteniendo la consistencia de tamaños y estados.
        </p>
      </div>
      ...
      <div className="space-y-24 px-8">
        <div className="space-y-12">
          {/* Section Header */}
          <div className="flex items-center gap-3 border-l-4 border-secondary-600 pl-4">
