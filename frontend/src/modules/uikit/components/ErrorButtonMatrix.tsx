    ...
    <div className="space-y-32 mt-16 pb-32 max-w-6xl">
      ...
      <div className="px-8 space-y-4">
        <div className="flex items-center gap-3">
          <Badge variant="outline" className="bg-error-600 text-white uppercase tracking-widest text-[10px]">Button System</Badge>
          <span className="text-sm font-medium text-neutral-400 dark:text-neutral-500 italic">Error Variant</span>
        </div>
        <h2 className="text-5xl font-black tracking-tighter text-neutral-900 uppercase">Destructive Action</h2>
        <p className="text-neutral-500 max-w-2xl text-lg">
          Variante para acciones críticas o destructivas, con estados de error claramente definidos.
        </p>
      </div>
      ...
      <div className="space-y-24 px-8">
        <div className="space-y-12">
          {/* Section Header */}
          <div className="flex items-center gap-3 border-l-4 border-error-600 pl-4">
