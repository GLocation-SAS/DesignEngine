...
const STATES = [
  ...
  { 
    ...
    label: "Hover", 
    props: { 
      className: "!bg-[#19635b] !text-white shadow-[inset_0px_0px_13.1px_1px_#9fd5ca]" 
    } 
  },
  { 
    key: "active", 
    label: "Pressed", 
    props: { 
      className: "!bg-[#134c45] !text-white" 
    } 
  },
    ...
    <div className="space-y-10 p-10 bg-white dark:bg-neutral-900 rounded-[40px] border border-neutral-200 dark:border-neutral-800 shadow-xl overflow-hidden">
      <div className="flex items-center justify-between mb-8">
        <div className="space-y-1">
          <Badge variant="surface" className="bg-success-50 text-success-600">Success Button</Badge>
          <h3 className="text-2xl font-black tracking-tight text-neutral-900 dark:text-white">Component Instance: node-2130-11695</h3>
        </div>
      </div>
