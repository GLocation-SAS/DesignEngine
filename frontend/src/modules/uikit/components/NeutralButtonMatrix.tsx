    ...
    <div className="space-y-32 mt-16 pb-32 max-w-6xl">
      ...
      <div className="px-8 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-medium text-neutral-400 dark:text-neutral-500 italic">Neutral Variant</span>
        </div>
        <h2 className="text-5xl font-black tracking-tighter text-neutral-900 uppercase">Neutral Action</h2>
      ...
      <div className="space-y-24 px-8">
        <div className="space-y-12">
          {/* Section Header */}
          <div className="flex items-center gap-3 border-l-4 border-neutral-600 pl-4">
