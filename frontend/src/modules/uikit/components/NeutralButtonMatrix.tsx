...
const STATES = [
  ...
  { 
    ...
    label: "Hover", 
    props: { 
      className: "!bg-[#5b5b5b] !text-white !border-[#5b5b5b]" 
    } 
  },
  { 
    key: "active", 
    label: "Pressed", 
    props: { 
      className: "!bg-[#383838] !text-white !border-[#383838]" 
    } 
  },
  { key: "disabled", label: "Disabled", props: { disabled: true } },
];

export function NeutralButtonMatrix() {
  return (
    <div className="space-y-10 p-10 bg-white dark:bg-neutral-900 rounded-[40px] border border-neutral-200 dark:border-neutral-800 shadow-xl overflow-hidden">
      <div className="flex items-center justify-between mb-8">
        <div className="space-y-1">
          <Badge variant="surface" className="bg-neutral-50 text-neutral-600">Neutral Button</Badge>
          <h3 className="text-2xl font-black tracking-tight text-neutral-900 dark:text-white">Component Instance: node-2130-11497</h3>
        </div>
      </div>
