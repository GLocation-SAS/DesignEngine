...
const SIZES = [
  { key: "L", label: "Large (56x32px)" },
  { key: "M", label: "Medium (48x24px)" },
  { key: "S", label: "Small (40x20px)" },
] as const;

const COMPOSITIONS = [
  { id: "full", label: "Completo (Label + Hint)", props: { label: "Notificaciones Push", hint: "Recibe alertas en tiempo real" } },
  { id: "label", label: "Solo Label", props: { label: "Modo Oscuro" } },
  { id: "hint", label: "Solo Hint", props: { hint: "Configuración avanzada" } },
  { id: "minimal", label: "Solo Switch", props: {} },
] as const;
