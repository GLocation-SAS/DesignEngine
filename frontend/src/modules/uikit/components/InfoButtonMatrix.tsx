...
const STATES = [
  ...
  { 
    ...
    label: "Hover", 
    props: { 
      className: "!bg-[#1d4ed8] !text-white shadow-[inset_0px_0px_13.1px_1px_#bfdbfe]" 
    } 
  },
  { 
    key: "active", 
    ...
    <div className="space-y-10 p-10 bg-white dark:bg-neutral-900 rounded-[40px] border border-neutral-200 dark:border-neutral-800 shadow-xl overflow-hidden">
      <div className="flex items-center justify-between mb-8">
        <div className="space-y-1">
          <Badge variant="surface" className="bg-info-50 text-info-600">Info Button</Badge>
          <h3 className="text-2xl font-black tracking-tight text-neutral-900 dark:text-white">Component Instance: node-2130-11563</h3>
        </div>
      </div>
