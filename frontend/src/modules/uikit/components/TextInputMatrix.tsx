    ...
    <div className="space-y-32 mt-16 pb-32 max-w-6xl">
      ...
      <div className="px-8 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-medium text-neutral-400 dark:text-neutral-500 italic">node-2130-11830</span>
        </div>
        <h2 className="text-5xl font-black tracking-tighter text-neutral-900 uppercase">Text Inputs</h2>
              ...
              <table className="w-full border-separate border-spacing-x-8 border-spacing-y-12">
                <thead>
                  <tr>
                    ...
                    <th className="text-center text-[10px] font-bold uppercase tracking-widest text-neutral-400 dark:text-neutral-500">Icon Left</th>
                    <th className="text-center text-[10px] font-bold uppercase tracking-widest text-neutral-400 dark:text-neutral-500">No Icons</th>
                    <th className="text-center text-[10px] font-bold uppercase tracking-widest text-neutral-400 dark:text-neutral-500">Icon Right</th>
                    <th className="text-center text-[10px] font-bold uppercase tracking-widest text-neutral-400 dark:text-neutral-500">Both Icons</th>
                  </tr>
                </thead>
                <tbody>
                  {STATES.map((state) => (
