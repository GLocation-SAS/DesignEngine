        ...
        <div className="absolute inset-0 flex flex-col justify-end p-10">
          <div className="relative z-10 max-w-lg rounded-xl bg-black/30 p-8 backdrop-blur-xl shadow-md">
            <div className="mb-6 flex flex-col gap-4">
              ...
              <p className="text-xl leading-relaxed text-neutral-900 font-light">
            ...
            <ul className="space-y-4">
              {FEATURES.map((feature, index) => (
                <li key={index} className="flex items-center gap-3 text-sm font-medium text-neutral-200">
                  <div className="flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-primary-800">
                    <CheckCircle2 className="h-3 w-3 text-primary-500" />
                  </div>
                  <span className="text-neutral-900 font-light text-[18px]">{feature}</span>
                </li>
              ))}
            </ul>
          </div>
